...
We have left out further comparisons on type systems, persistent identifiers and social aspects as principles and practices within these dimensions are still taking form within the FDO community (\vpageref*{ch3:next-step-fdo}).
...
Based on the analysis shown in Table \vref{ch3:fdo-web-interoperability-framework}, we draw the following conclusions:
...
\hypertarget{ch3:doip-fdo-compare}{%
