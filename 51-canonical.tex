...
established \cite{Stodden 2016,Leipzig 2021,Katz 2021a}, and adaptation of \emph{workflow management
...
\emph{common motifs} for workflow operations \cite{Katz 2021a0} (e.g.~Data
...
components} had prototypical building blocks \cite{Katz 2021a1} which were
...
The \footurl{https://toolshed.g2.bx.psu.edu/}{Galaxy toolshed} \cite{Katz 2021a2} is
...
\cite{Vivian 2017}. However workflow engines have multiple dependencies and often
...
\emph{application suite} (bio.tools entry \cite{Katz 2021a5}, homepage,
...
applies \cite{Katz 2021a7} (e.g.~easy to install, documented, parallelizable,
...
adapt the software to be workflow-ready \cite{Katz 2021a7} before using them as
...
\cite{Katz 2021a9} and Biohackathons \cite{ch6-40}.
