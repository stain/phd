...
\begin{figure}%[t!]
  \includegraphics{figures/ch05/ro-crate-overview.pdf}
...
\subsubsubsection{Linked Data as a foundation}\label{ch5:linkeddata}
...
\subsubsubsection{RO-Crate is a self-described container}\label{ch5:selfdescribed}
...
\begin{figure}%[t!]
  \includegraphics[width=0.9\textwidth]{figures/ch05/ro-crate-uml.pdf}
...
RO-Crate definition (see \textit{Appendix~\vref{ch5:formaldefinition}}). An
...
JSON-LD\footnote{\url{https://json-ld.org/}} \cite{ch5-112}
...
\subsubsubsection{RO-Crate JSON-LD}\label{ch5:jsonld}
...
\subsubsubsection{Flattened JSON-LD}\label{ch5:flattened-json-ld}}
...
\subsubsubsection{JSON-LD context}\label{ch5:json-ld-context}
...
for
repositories and Bioschemas \cite{ch5-58}
for
...
\cite{Ó Carragáin 2019}: simplicity, structured metadata and the
use of JSON-LD.
...
\cite{ch5-58}, OpenAIRE \cite{ch5-100}
...
\subsubsubsection{Norms}\label{ch5:norms}
...
\subsubsubsection{Open Platforms}\label{ch5:open-platforms}
...
\subsubsubsection{Profile for describing workflows}
...
Refinery\footnote{\url{https://github.com/DiSSCo/SDR}} \cite{ch5-122} these
...
\subsubsubsection{Profile for testing
workflows}\label{ch5:profile-for-testing-workflows}
...
\textbf{BCO RO-Crate}\footnote{\url{https://biocompute-objects.github.io/bco-ro-crate/}} \cite{ch5-109},
...
\emph{separation of concerns} is shown in Figure \ref{fig:sep_concerns},
and highlights how
...
\begin{figure}%[t]
  \includegraphics{figures/ch05/ro-crate-bco-sep-of-concerns.pdf}
  ...
  {ch5-85} to support larger data. RO-Crate gathers all these local
  ...
  \cite{Chart 2016} features to ``complete'' the
...
metadata to allow their future reuse (Figure \vref{fig:hdc}). To support the incorporation of data, code, and other artefacts
...
\begin{figure}%[t!]
  \includegraphics{figures/ch05/data-commons-ro-crate-figure-5.pdf}
...
conventions, as explored in Sections~\cref{sec:profiles} and \vref
{sec:inuse}. Specialization comes
