...
\cite{Kurowski 2021} details\footnote{
  \acrshort{EOSC-IF} has since been expanded on by a draft EOSC report \cite{Åkerström 2024}, which references the preprint of this section \cite{Soiland-Reyes 2023c}.
}
