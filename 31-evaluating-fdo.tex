...
The FAIR Digital Object guidelines \cite{Bonino 2019} sets out recommendations for FDO implementations. Note that the proposed update to FDO specification \cite{Anders 2023} clarifies these definitions with equivalent identifiers\footnote{
  Newer \cite{Anders 2023} renames \texttt{FDOF*} to \texttt{FDOR*} but follows same ordering. For a brief listing of the requirements, see section \vref{ch10:fdo-guidelines}.
...
Here we evaluate to what extent the FDO guidelines and its implementation with DOIP and Linked Data Platform \cite{Bonino 2020} comply with the FAIR principles \cite{Wilkinson 2016}\footnote{
