...
Supplement 12: \emph{Sharing interoperable workflow provenance: A review of best practices and their practical application in CWLProv} \cite{Khan 2019} (Main contribution pre-dates UvA
affiliation) 

Supplement 13: \emph{IEEE Standard for Bioinformatics Analyses Generated by High-Throughput Sequencing (HTS) to Facilitate Communication: IEEE Std 2791-2020} \cite{ieee2791}

\footurl{https://doi.org/10.37044/osf.io/c724r}{Supplement 14}: \emph{BioHackEU22 Project 22: Plant data exchange and standard interoperability}

\footurl{https://s11.no/2023/phd/workflow-run-crate/}{Supplement 15}: \emph{Recording provenance of workflow runs with RO-Crate} \cite{workflow-run-crate}

\footurl{https://doi.org/10.5281/zenodo.3337883}{Supplement 16}: \emph{RO-Crate, a lightweight approach to Research Object data packaging} \cite{10.5281/zenodo.3337883} (Main contribution pre-dates UvA affiliation) 

Supplement 17: \emph{Federated causal inference based on real-world observational data sources: application to a SARS-CoV-2 vaccine effectiveness assessment} \cite{Meurisse 2023}

Supplement 18: \emph{Linking provenance and its metadata in multi-organizational environments of life sciences} \cite{Wittner 2023b}

\footurl{https://doi.org/10.37044/osf.io/24jst}{Supplement 19}: \emph{BioHackEU22 Report: Enhancing Research Data Management in Galaxy and Data Stewardship Wizard by utilising RO-Crates} \cite{Eguinoa 2023}
...
\begin{itemize}
  ...
  \item  \footurl{https://w3id.org/a2a-fair-metrics/}{Benchmarks for Apples-to-Apples FAIR Signposting}, main author and maintainer (see \cite{10.5281/zenodo.7463421})
...
\begin{itemize}
  ...
  \item 
    \footurl{https://www.researchobject.org/ro-crate/1.1/ro-crate-preview.html}{RO-Crate of RO-Crate specification 1.1} \cite{rocrate1.1}
  \item 
    \footurl{https://www.researchobject.org/ro-crate/1.2-DRAFT/ro-crate-preview.html}{RO-Crate of RO-Crate specification 1.2-DRAFT}
