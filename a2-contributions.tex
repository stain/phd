...
\footurl{https://s11.no/2023/phd/workflow-run-crate/}{Supplement 15}: \emph{Recording provenance of workflow runs with RO-Crate}

\footurl{https://doi.org/10.5281/zenodo.3337883}{Supplement 16}: \emph{RO-Crate, a lightweight approach to Research Object data packaging} \cite{10.5281/zenodo.3337883} \emph{(Main contribution pre-dates UvA affiliation)} 
