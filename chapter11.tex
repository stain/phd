...
I want to thank Simone Leo, which persistent work and leadership on Workflow Run Crate\footnote\url{https://w3id.org/ro/wfrun/} and the RO-Crate Python library \cite{Droesbeke 2022} has shown that RO-Crate works in practice even for detailed provenance.

RO-Crate is standing on the shoulders of giants, and I would like to thank the whole Research Object community \emph{goble-ro2018} for persisting on the early RO ideas \cite{ch5-93, Bechhofer 2013}. I have particular fond memories of whiteboard sessions with Sean Bechhofer, Khalid Belhajjame, Paolo Missier, David De Roure and Kevin Page in the productive Wf4Ever project\footnote{\url{https://s11.no/2020/archive/wf4ever/}} that laid the foundation for what is now RO-Crate.


As of 2023-06-15, the \emph{RO-Crate} Community members\footnote{\url{https://www.researchobject.org/ro-crate/community.html}} are:
...
\subsection{Acknowledgements for co-authored chapters}
...
Chapters \vref{ch5:packaging-research-artefacts-with-ro-crate} and \vref{ch5:formaldefinition} are published in the journal \emph{Data Science}.
...
\subsection{Acknowledgements Chapter 6}

Chapter \vref{ch6:making-canonical-workflow-building-blocks-interoperable-across-workflow-languages} is adapted from journal article published in \emph{Data Intelligence}.
...
\subsection{Acknowledgements Chapter 7}
...
\subsection{Acknowledgements Chapter 8}

Chapter \vref{ch8:the-specimen-data-refinery} is adapted from a journal article published in \emph{Data Intelligence}.
