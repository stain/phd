...
I want to thank Simone Leo, which persistent work and leadership on Workflow Run Crate\footnote\url{https://w3id.org/ro/wfrun/} and the RO-Crate Python library \cite{ro-crate-py} has shown that RO-Crate works in practice even for detailed provenance.
