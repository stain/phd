...
FDO is an evolving concept. A set of FDO Demonstrators \cite{Wittenburg 2022} highlights how current adapters are approaching implementations of FDO from different angles:
...
Existing FDO implementations \cite{Wittenburg 2022} are thus not fully consolidated in choices such as protocols, type systems and serialisations -- this divergence and corresponding additional technical requirements mean that FDOs are not yet in a single ecosystem.
