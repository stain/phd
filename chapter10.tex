...
Contributor Roles Taxonomy (CASRAI CrEDiT) \cite{Brand 2015}:

For all chapters except chapter 8, I am the main author of the corresponding
manuscripts and have contributed to all aspects of the research. See chapter \vref{ch11:acknowledgements} for acknowledgements beyond authorship covered below.

For Chapter \ref{ch2:updating-linked-data-practices-for-fair-digital-object-principles} and section \ref{making-canonical-workflow-building-blocks-interoperable-across-workflow-languages} I am a member of FAIR Digital Object Forum working groups FDO-CWFR, FDO-SEM and have contributions to FDO specifications \cite{fdo-RequirementSpec}, \cite{fdo-Overview}, 

For Chapter \ref{ch5:packaging-research-artefacts-with-ro-crate} and \ref{formaldefinition} I co-chair the
\href{https://www.researchobject.org/ro-crate/community}{RO-Crate
community} together with Peter Sefton. I am the sole author of chapter \ref{formaldefinition}, which was published as an appendix.
...
Section \ref{ch2:updating-linked-data-practices-for-fair-digital-object-principles} was co-authored by:
...
Chapters \vref{ch5:packaging-research-artefacts-with-ro-crate} and \vref{formaldefinition} were co-authored by:
...
\subsubsection{Contributions for }}: \href{../canonical-workflow-building-blocks/}{Making
