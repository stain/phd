...
\emph{Computational Workflows} (or Scientific Workflows) are used to structure and automate data analysis pipelines so they can be scalable, portable and explainable \cite{Atkinson 2017}. There exists a plethora of workflow systems \cite{Leipzig 2021} and languages \cite{Amstutz 2021}, recent effort have also specified a Common Workflow Language \cite{Crusoe 2022} that is implemented by multiple engines. 
