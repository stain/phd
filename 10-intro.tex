...
Following the lessons learnt on early RO implementations and the emerging FAIR principles \cite{Wilkinson 2016,Jacobsen 2020}, \cite{10.5281/zenodo.3337883,Sefton 2018} The updated aims of \emph{FAIR Research Objects} can be summarised as:
...
The second research question (RQ2) is if a more pragmatic use of Linked Data practices can better implement Research Objects for a wider developer audience, by using more familiar Web technologies and give lightweight recommendations.
