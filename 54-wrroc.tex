\subsection{Recording provenance of workflow runs with RO-Crate}
\label{ch54:wrroc}
...
\cite{Crusoe 2022} -- a standard workflow specification adopted by at least a dozen different workflow \footurl{https://www.commonwl.org/implementations/}{systems}. Although CWLProv includes prospective provenance as a \emph{plan}
...
%% 
\subsection{The Workflow Run RO-Crate profiles}\label{the-workflow-run-ro-crate-profiles}
...
(1) Process Run \footurl{https://w3id.org/ro/wfrun/process}{Crate}
 to describe the execution of one or more tools that contribute to a computation;
(2) Workflow Run \footurl{https://w3id.org/ro/wfrun/workflow}{Crate}
 to describe a computation orchestrated by a predefined workflow; 
(3) Provenance Run \footurl{https://w3id.org/ro/wfrun/provenance}{Crate}
...
\subsubsection{Process Run Crate}\label{process-run-crate}
...
\subsubsection{Workflow Run Crate}\label{workflow-run-crate}
...
\subsubsection{Provenance Run Crate}\label{provenance-run-crate}
...
\subsubsection{Runcrate}\label{runcrate}
...
\subsubsection{Galaxy}\label{galaxy}
...
\subsubsection{COMPSs}\label{compss}
...
\subsubsection{StreamFlow}\label{streamflow}
...
\subsubsection{WfExS-backend}\label{wfexs}
...
\subsubsection{Sapporo}\label{sapporo}
...
\subsubsection{Autosubmit}\label{autosubmit}
...
%% 
\subsection{Exemplary Use Cases}\label{exemplary-use-cases}
...
\subsubsection{Provenance Run Crate for Digital Pathology}\label{provenance-run-crate-for-digital-pathology}
...
\subsubsection{Process Run Crate and CPM RO-Crate for cancer detection}\label{process-run-crate-and-cpm-ro-crate-for-cancer-detection}
...
\subsubsection{Five Safes Workflow Run Crate}\label{trusted-workflow-run-crate}
