...
(1) \footurl{https://w3id.org/ro/wfrun/process}{Process Run Crate}
 to describe the execution of one or more tools that contribute to a computation;
(2) \footurl{https://w3id.org/ro/wfrun/workflow}{Workflow Run Crate}
 to describe a computation orchestrated by a predefined workflow; 
(3) \footurl{https://w3id.org/ro/wfrun/provenance}{Provenance Run Crate}
...
The listing below (Listing~\vref{ch54:lst:ml_pipeline_streamflow_report}) shows the output of the
...
For instance, the \footurl{https://www.w3.org/TR/sparql11-overview/}{SPARQL} query in listing \vref{ch54:sparq} returns all actions in a Workflow Run RO-Crate, together with their instruments and their starting and ending times:
