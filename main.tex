...
\chapter{FAIR Digital Objects and Linked Data}l\label{chapter:fdo}
\include{chapter03}
\include{chapter02}

\chapter{RO-Crate}\label{chapter:ro-crate}
\include{chapter05}
\include{chapter04}
\include{chapter05b}

\chapter{Computational Workflows}\label{chapter:workflows}
\include{chapter06}
\include{chapter08}
\include{chapter07}
