...
These comparisons highlighted that the Web on the othe rhand has a strong, flexible and mature technology stack, which would be a solid basis for implementing FDO. 
However, if this is to use Linked Data technologies, these must be made more predictable and consistent in order to help realize such an ecosystem.
