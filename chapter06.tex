...
established \cite{ch6-1,ch6-2,ch6-3}, and adaptation of \emph{workflow management
...
research software usage \emph{FAIR} and reproducible \cite{ch6-5,ch6-6,ch6-7}.
Recently it is also argued that computational workflows should also be
treated as FAIR Digital Objects \cite{ch6-8} in their own right, with
identifier, metadata \cite{ch6-2} and interoperability requirements \cite{ch6-9}.
...
principles for research software development best practices \cite{ch6-7}.
...
(Galaxy \cite{ch6-18}, CWL \cite{ch6-19}, PyCOMPSs \cite{ch6-20}) or manually generated
...
The \emph{Common Workflow Language} (\textbf{CWL}) \cite{ch6-19} has a strong
...
\cite{ch6-34}, with the option of abstract CWL for describing the canonical
...
which should have a corresponding persistent identifier (PID) \cite{ch6-38}.
