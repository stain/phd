...
In addition the \emph{Process Crate} profile was shown to be suitable also for ``manual workflows'' where processes are executed by hand, as illustrated by the \footurl{https://w3id.org/ro/doi/10.5281/zenodo.6913045}{BY-COVID WP5 T5.2 Baseline Use Case} RO-Crate from the BY-COVID \cite{Meurisse 2023} project in figure \vref{ch61:fig:baseline-usecase}.

\begin{figure}[htb]
  \includegraphics[width=\textwidth]{figures/ch09/baseline-usecase-crate.pdf}
    \caption[Example of RO-Crate using Profile Crate profile]{\textbf{Example of RO-Crate using Profile Crate profile}. ..
    }
...
The practical implementation of RO-Crate by multiple developers highlights the 
