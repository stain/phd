...
Object Crates (RO-Crates) \cite{ch8-22,ch8-23} and WorkflowHub \cite{ch8-24}, and
...
`workflow components' \cite{ch8-48}. openDS is essential to future FAIR
...
RO-Crate \cite{ch8-22,ch8-23} has been established as a community standard to
...
\cite{ch8-62} with Digital Object Interface Protocol (DOIP) \cite{ch8-63}, Digital
