...
\begin{figure}%[t]
  \includegraphics[width=\textwidth]{figures/ch/figure2.png}
...
\subsubsection{Different FDO implementations working together}\label{different-fdo-implementations-working-together}
